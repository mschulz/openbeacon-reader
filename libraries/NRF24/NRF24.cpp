...
boolean NRF24::setThisAddress(uint8_t* address, uint8_t len)
{
    ...
    spiBurstWriteRegister(NRF24_REG_0B_RX_ADDR_P1, address, len);
...
{
    spiWriteRegister(NRF24_REG_00_CONFIG, NRF24_DEFAULT_CONFIGURATION);
    digitalWrite(_chipEnablePin, LOW);
    return true;
}
...
{
    spiWriteRegister(NRF24_REG_00_CONFIG, NRF24_DEFAULT_CONFIGURATION | NRF24_PWR_UP | NRF24_PRIM_RX);
...
boolean NRF24::powerUpTx()
{
    ...
    digitalWrite(_chipEnablePin, LOW);
    spiWriteRegister(NRF24_REG_00_CONFIG, NRF24_DEFAULT_CONFIGURATION | NRF24_PWR_UP);
    digitalWrite(_chipEnablePin, HIGH);
    return true;
}
